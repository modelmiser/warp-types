...
### For Users
- Clone the repo and run `cargo test && cargo test --examples` (317 unit + 28 doc + 50 example = 395 main-crate tests; sibling crates add 195 more via `cargo test --workspace`)
