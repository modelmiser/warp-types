...
\item \textit{Three concrete CSP untypability witnesses and four inversion lemmas} (\S\ref{sec:csp-collective}) --- three \texttt{j1\_*\_untypable} theorems (opposite-corners send, diagonal send, collective after column split) together with the four inversion lemmas grouped above them in \texttt{Csp.lean}.
