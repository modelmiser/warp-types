...
Five untypability theorems model real GPU bugs at `n = 32`: <!-- unguarded: per-file Lean theorem count; the guard totals only Basic + Metatheory -->
...
Four per-domain theorems: <!-- unguarded: per-file Lean theorem count; the guard totals only Basic + Metatheory -->
...
Four per-domain theorems, mirroring Fence's: <!-- unguarded: per-file Lean theorem count; the guard totals only Basic + Metatheory -->
