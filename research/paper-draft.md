...
- ~~**Citations**~~ — DONE. `research/references.bib` has 19 BibTeX entries. **Two need manual verification before submission:** Li-Donaldson 2017 (SIMT divergence type system) and Bao-Chen-Hovemeyer 2020 (GPU warp verification) — not found on DBLP/ACM DL. Check original source or correct author names/year.
