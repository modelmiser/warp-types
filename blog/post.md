...
- 395 tests (317 unit + 50 example + 28 doc), all passing on both NVIDIA and AMD
...
- Real GPU execution on NVIDIA H200 SXM and RTX 4000 Ada; AMD MI300X mask-correctness verified via HIP
